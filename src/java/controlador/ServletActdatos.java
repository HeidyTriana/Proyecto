 ...
 * @author Usuario
 */
@WebServlet(name = "ServletActdatos", urlPatterns = {"/ServletActdatos"})
public class ServletActdatos extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        PrintWriter out = response.getWriter();
         ...
         if (x>0){
             ...
             request.getRequestDispatcher("Configurarper.jsp").forward(request, response);
         }
